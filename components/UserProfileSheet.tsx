...
export const UserProfileSheet = ({ isVisible, onClose }: UserProfileSheetProps) => {
  ...
  const backdropStyle = useAnimatedStyle(() => ({
    opacity: interpolate(translateY.value, [SCREEN_HEIGHT, SCREEN_HEIGHT * 0.3], [0, 0.5]),
  }));
  ...
  return (
    <View style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, zIndex: 9999 }}>
      ...
      <Animated.View 
        ...
        style={[{ height: SCREEN_HEIGHT * 0.7, zIndex: 10000 }, animatedStyle]}
      >
        ...
        <View className="px-5">
          ...
          <TouchableOpacity 
            className="bg-danger/10 rounded-2xl p-4 mb-6 flex-row items-center justify-center"
